...
# Tämän käyttäminen aiheutti sen, että elokuvalistauksen järjestykseen liittyvä
# sessiomuuttuja kaataa sovelluksen JYU-serverillä
# def auth(f):
...
def index():
	...
	# Jos kirjautumisen sessiomuuttujaa ei löydy niin ohjataan kirjautumissivulle
	return redirect(url_for('login'))	
...
def login():
	if request.method == 'POST':
		...
		# En saanut alla olevaa piilotettua salasanavertailua toimimaan --> "Unicode-objects must be encoded before hashing"
		...
		# if tunnus == "tiea218@foobar.example" and m.digest() == tarkistussana:
		# 	# jos kaikki ok niin asetetaan sessioon tieto kirjautumisesta ja ohjataan laskurisivulle
		# 	session['kirjautunut'] = "ok"
		# 	return redirect(url_for('index'))			
		# elif tunnus != "tiea218@foobar.example" and m.digest() == tarkistussana:
		# 	herja = u"Väärä käyttäjätunnus!"
		# 	return render_template('login.html', herja=herja, herja2=herja2)
		# elif tunnus == "tiea218@foobar.example" and m.digest() != tarkistussana:
		# 	herja2 = u"Väärä salasana!"
